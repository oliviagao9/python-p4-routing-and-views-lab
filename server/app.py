...
# It should print the string in the terminal and display 
# it in the web browser. Its URL should be of the format /print/parameter.
...
def math(num1, operation, num2):
    ...
    return 'opeartion is not recongized. Please use one of the following: + - * div %'
